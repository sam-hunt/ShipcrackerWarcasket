...
//  - never draws into portraits or the pawn cache: both bake with DrawMeshNow, which ignores
//    property blocks and would bake the overlay at full opacity. PawnRenderer_Patches keeps a
//    glowing wearer out of the cache. The node stays in the cached request list at alpha 0
//    while idle rather than toggling CanDrawNow, which would rebuild the requests on every cast.
